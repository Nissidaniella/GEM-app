      ...
      <div className="footer-content">
        ...
        <div className="footer-col">
          ...
          <div className="footer-links">
            ...
            <a onClick={() => onNavigate('campaigns')} style={{ cursor: 'pointer' }}>Campaigns</a>
            <a onClick={() => onNavigate('blog')} style={{ cursor: 'pointer' }}>Blog</a>
            <a onClick={() => onNavigate('contact')} style={{ cursor: 'pointer' }}>Sign-up</a>
          </div>
        </div>
